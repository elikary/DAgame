...
public class Device implements Runnable {
     ...
     * @throws java.net.UnknownHostException If the tracker can't be found
     * @throws java.io.IOException If an IOException occurs in the communication
     */
     ...
     * @throws java.io.IOException if the port could not be opened.
     */
